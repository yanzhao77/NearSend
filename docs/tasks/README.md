...
T12 UI 全平台改造已通过 [PR #61](https://github.com/yanzhao77/NearSend/pull/61) 于 2026-09-23 squash 合并到 `master`。下表中的 T12 状态仍按各自退出门槛记录：代码合并不替代 Flutter SDK、目标设备构建、真机截图、键盘/生命周期和屏幕阅读器证据。
...
| [T12-00](T12-00.md) | UI 平台能力 S0 与任务基线 | 已完成：探针记录；平台能力未全部验证 | `feat/ui-baseline` → [#61](https://github.com/yanzhao77/NearSend/pull/61)（已合并） |
| [T12-01](T12-01.md) | 主题与 Design Token | 就绪 | `feat/ui-baseline` → [#61](https://github.com/yanzhao77/NearSend/pull/61)（已合并） |
| [T12-02](T12-02.md) | 共享 UI 组件 | 就绪 | `feat/ui-baseline` → [#61](https://github.com/yanzhao77/NearSend/pull/61)（已合并） |
| [T12-03](T12-03.md) | 响应式应用壳与真实数据读模型 | 待验证 | `feat/ui-baseline` → [#61](https://github.com/yanzhao77/NearSend/pull/61)（已合并） |
| [T12-04](T12-04.md) | 首页与关于页 | 待验证 | `feat/ui-baseline` → [#61](https://github.com/yanzhao77/NearSend/pull/61)（已合并） |
| [T12-05](T12-05.md) | 配对与连接页 | 待验证 | `feat/ui-baseline` → [#61](https://github.com/yanzhao77/NearSend/pull/61)（已合并） |
| [T12-06](T12-06.md) | 发送流程页面 | 待验证 | `feat/ui-baseline` → [#61](https://github.com/yanzhao77/NearSend/pull/61)（已合并） |
| [T12-07](T12-07.md) | 接收流程与空间预检 | 待验证 | `feat/ui-baseline` → [#61](https://github.com/yanzhao77/NearSend/pull/61)（已合并） |
...
| T10 | 安装升级与发布 | 进行中（GitHub Actions 已发布预览基线 `v0.1.7`；正式签名、升级和正式分发待完成） | [发布说明](../releases/GITHUB_ACTION_RELEASES.md) |
