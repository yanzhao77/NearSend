...
| NearSend 1.2 升级 | **进行中**：V12-00/V12-01 保留平台验证阻塞；V12-02/V12-03 已完成当前环境代码验证；V12-04 安全身份基础已实现；V12-05 mDNS 代码与当前环境构建通过，双机实测待补 | 按 [1.2 计划](releases/1.2/PLAN.md) 推进 V12-06 至 V12-12，并补齐 V12-04/V12-05 协议绑定和 Android/Windows 目标设备证据 |
