...
本次改动随 PR [#72](https://github.com/yanzhao77/NearSend/pull/72) 合并，`master` 合并提交为 `a74e264`；合并后 CI 与预览版 [v0.1.8](https://github.com/yanzhao77/NearSend/releases/tag/v0.1.8) 已通过。真机相机权限、实际扫码、自动指纹校验和断网重连仍需按验收矩阵人工复核。
